          ...
          >
            ...
            >
              ...
              <NuxtLink
                ...
                class="py-2 border-[#9f91e1] bg-[#3253A4] text-white font-semibold text-center rounded-lg transition duration-300"
...
const fetchPrograms = async () => {
  try {
    const response = await fetch(
      "https://cms-les.naditechno.id/api/program/list/1?limit=3",
      {
        method: "GET",
        headers: {
