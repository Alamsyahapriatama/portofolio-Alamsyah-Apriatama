          ...
          <div class="relative">
            ...
            <div class="space-y-4 py-6">
              ...
              >
                ...
                <p class="text-base text-gray-600 dark:text-gray-300">
                  Syarat utama untuk mengikuti IFC adalah berstatus mahasiswa
                  aktif.
                </p>
              </div>
              <div
              ...
              >
                ...
                <p class="text-base text-gray-600 dark:text-gray-300">
                  Punya keinginan kuat untuk terus belajar, karena memang
                  belajar programming itu tidaklah mudah.
                </p>
              </div>
            </div>
            ...
            <div class="space-y-4 pt-8">
              ...
              >
                ...
                <p class="text-base text-gray-600 dark:text-gray-300">
                  Kantor Salam Homecare Jadetabek
                  <span
                    ><a
                      class="text-blue-500"
                      href="https://maps.app.goo.gl/ET7MCSDx5XRz476i8"
                      target="_blank"
                      >Link Google Maps</a
                    ></span
                  >
