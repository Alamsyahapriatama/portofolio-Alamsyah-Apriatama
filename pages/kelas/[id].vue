<template>
  <section class="h-[300px] bg-[#3253A4] bg-cover bg-center">
    <AtomsContainer class="h-full">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-1 md:grid-cols-1 gap-6 h-full">
        <div
          class="relative min-h-[180px] h-full flex items-center justify-center"
        >
          ...
          <div class="relative mt-[105px]">
            ...
            <h3 class="text-center text-white text-2xl mt-2">
              Dari Canggung ke Cas-Cis-Cus, Bareng Les Belajar!
            </h3>
          </div>
        </div>
      </div>
      ...
      >
        <div class="lg:py-6">
          <div class="text-center lg:text-left">
            ...
            <p class="text-2xl pt-8">
              Kelas ini dirancang khusus untuk membantu kamu meningkatkan
              kemampuan berbahasa Inggris secara bertahap, dengan metode yang
        ...
        <div class="lg:h-full hidden md:flex">
          ...
          >
            ...
            ></div>
            <div
              class="absolute w-5/5 h-full z-10 p-1 -translate-y-1/2 top-1/2 right-3 rounded-3xl shadow-lg shadow-box-shadow"
            >
              <img
  ...
  <section class="pt-2 md:pt-2 py-8">
    <AtomsContainer>
      ...
      <div
        class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-2 md:gap-6 pt-2 mt-[-80px] md:mt-[-100px]"
      >
        <div
        ...
        >
          <!-- ICON CENTERED -->
          <div
            class="flex justify-center items-center text-black text-2xl mx-auto"
          >
            <NuxtImg :src="artikel.image" alt="artikel.title" class="w-2/5" />
          </div>

          <h3
            class="mt-4 text-black-800 text-center dark:text-black-200 text-lg font-semibold"
          >
            {{ artikel.title }}
          </h3>
          <p class="pt-4 px-8">
            Didirikan lebih dari 17 tahun yang lalu sejak 2007, sehingga lebih
  ...
  <section class="pt-2 md:pt-2 py-20">
    <AtomsContainer>
      <div class="lg:h-full w-full">
        <div class="relative">
          <h2 class="text-center text-black text-3xl font-semibold">
            Biaya Kursus Kelas Offline
          </h2>
          <h3
            class="text-black-800 text-center dark:text-black-200 font-semibold text-xl"
          >
            Solusi Ujian Online Terjangkau untuk Semua Skala 🚀
          </h3>
          <div
            class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 pt-8"
          >
            <div
            ...
            >
              ...
              <div
                class="mt-4 grid grid-cols-2 gap-x-4 text-black-600 dark:text-black-300 text-base rounded-xl shadow-md border border-gray-300 p-4"
              >
                ...
                <div
                  class="pt-2 text-black-800 dark:text-black-100 font-bold text-right"
                >
                  {{ paket.price }}
                </div>

                <div class="pt-2 font-medium">Info Harga</div>
                <div class="pt-2 text-black-800 dark:text-black-100 text-right">
                  {{ paket.priceInfo }}
                </div>
              </div>
            </div>
...
const fetchBlogs = async () => {
  try {
    const response = await fetch(
      "https://api-community-management.lesbahasa/galeri",
      {
        method: "GET",
        headers: {
...
const fetchTestimonis = async () => {
  try {
    const response = await fetch(
      "https://api-community-management.lesbahasa/testimoni",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
const fetchLayanans = async () => {
  try {
    const response = await fetch(
      "https://api-community-management.lesbahasa/layanan?orderBy=nomor&order=ASC",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
const faqs = ref([
  {
    ...
    answer:
      "CBT Online adalah platform ujian berbasis web yang memudahkan penyelenggaraan ujian daring dengan fitur lengkap, fleksibel, dan terjangkau.",
    open: false,
  },
  {
    question: "Siapa saja yang bisa menggunakan CBT Online?",
    answer:
      "CBT Online dapat digunakan oleh sekolah, lembaga pelatihan, perusahaan, atau institusi pendidikan lainnya yang membutuhkan sistem ujian daring.",
    open: false,
  },
  {
    question: "Apa saja jenis soal yang bisa digunakan?",
    answer:
      "Platform ini mendukung soal pilihan ganda, essay, serta pengacakan soal dan jawaban untuk mencegah kecurangan.",
    open: false,
  },
  {
    question: "Apakah CBT Online bisa digunakan di HP?",
    answer:
      "Ya, CBT Online mendukung multi-device, termasuk penggunaan di HP, tablet, dan laptop.",
    open: false,
  },
  {
    question: "Apakah hasil ujian bisa langsung direkap?",
    answer:
      "Ya, hasil ujian direkap otomatis dan bisa di-export dalam format Excel atau PDF.",
    open: false,
  },
  {
    question: "Apakah ada fitur pembayaran otomatis?",
    answer:
      "CBT Online terintegrasi dengan payment gateway Xendit untuk mempermudah pembayaran layanan atau biaya peserta.",
    open: false,
  },
  {
    question: "Apakah ada akun terpisah untuk admin, guru, dan peserta?",
    answer:
      "Ya, sistem mendukung role-based access untuk admin, guru/pengajar, dan peserta ujian.",
    open: false,
  },
]);
...
const artikelPosts = [
  {
    id: 1,
    image:
      "https://static.wixstatic.com/media/e09e14_977480f4326a4be0b394a0eba1849259~mv2.png/v1/fill/w_128,h_128,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/5229578.png",
    title: "Exclusive Class",
    description:
      "Kelas hanya terdiri dari 3 peserta, memberikan suasana belajar lebih fokus dan personal.",
  },
  {
    id: 2,
    image:
      "https://static.wixstatic.com/media/e09e14_354dd187e9f647ffacd8f4e9693b56f3~mv2.png/v1/fill/w_128,h_128,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/10907018.png",
    title: "Flexible Format",
    description:
      "Peserta dapat memilih untuk mengikuti kelas secara tatap muka atau daring, sesuai preferensi.",
  },
  {
    id: 3,
    image:
      "https://static.wixstatic.com/media/e09e14_cf3d38017dc1401fadf165e6c40e369d~mv2.png/v1/fill/w_128,h_128,al_c,q_85,usm_0.66_1.00_0.01,enc_avif,quality_auto/8324227.png",
    title: "Fix Schedule",
    description:
      "Peserta dapat memilih untuk jadwal belajar dari yang telah ditentukan oleh kami.",
  },
];
</script>
